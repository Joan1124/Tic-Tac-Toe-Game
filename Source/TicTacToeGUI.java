...
import javax.swing.*;
// Allows to add GUI components: Buttons, titleLabels, and Labels
...
public class TicTacToeGUI {
	...
	public void changePanel(String panelName) {
		...
		//If the loop has not resulted in a return by this point, there is an error, so this JOptionPane notifies the user of the error
		JOptionPane.showMessageDialog(tictactoeFrame, "Error changing panels, please make sure the string when calling the changePanel function is valid.", "CardLayout Error", JOptionPane.WARNING_MESSAGE);
